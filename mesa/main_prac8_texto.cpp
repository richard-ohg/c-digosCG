...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_goku.LoadTGA("goku.tga");
	t_goku.BuildGLTexture();
	t_goku.ReleaseImage();

	t_naruto.LoadTGA("naruto.tga");
	t_naruto.BuildGLTexture();
	t_naruto.ReleaseImage();

	t_pikachu.LoadTGA("pikachu.tga");
	t_pikachu.BuildGLTexture();
	t_pikachu.ReleaseImage();
