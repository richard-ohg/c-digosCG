...
void CFiguras::skybox (float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::prisma_text(GLuint text, GLuint text2)  //Funcion creacion prisma
{
