...
float pos_camX = 0, pos_camY = 0, pos_camZ = -22; 
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	paredes.LoadTGA("paredes.tga");
	paredes.BuildGLTexture();
	paredes.ReleaseImage();

	techo2.LoadTGA("cielo2.tga");
...
void prisma (GLuint textura1, GLuint textura2,GLuint textura3, GLuint textura4)  //Funcion creacion prisma
{
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(pos_camX, pos_camY, pos_camZ);
		...
		glPushMatrix(); 
			...
			prisma(paredes.GLindex, ventana.GLindex, piso.GLindex, techo2.GLindex);
		glPopMatrix();
