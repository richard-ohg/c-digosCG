...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_alga.LoadTGA("alga.tga");
	t_alga.BuildGLTexture();
	t_alga.ReleaseImage();
}
...
void cuadro(GLuint textura)
{
	GLfloat vertice[4][3] = {
		{ -0.5 ,-0.5, 0.0 },    //Coordenadas Vértice 0 V0
		{ 0.5 ,-0.5, 0.0 },    //Coordenadas Vértice 1 V1
		{ 0.5 ,0.5, 0.0 },    //Coordenadas Vértice 2 V2
		{ -0.5 ,0.5, 0.0 },    //Coordenadas Vértice 3 V3
	};
...
void cuadroTiburon(GLuint textura)
{
	GLfloat vertice [8][3] = {
				{0.5 ,-0.5, 0.5},    //Coordenadas Vértice 0 V0
				{-0.5 ,-0.5, 0.5},    //Coordenadas Vértice 1 V1
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(pos_camX, pos_camY, pos_camZ);
		...
		glPushMatrix();
			...
			cuadroTiburon(t_tiburon.GLindex);
		glPopMatrix();
		glPushMatrix();
			glTranslatef(0.5, 0, 0);
			cuadro(t_alga.GLindex);
		glPopMatrix();
		glPushMatrix();
			glTranslatef(0.5, 0, 0);
			glRotatef(-90,1,0,0);
		...
		glPushMatrix(); 
			...
			prisma(t_agua.GLindex, t_mosaico.GLindex);
		glPopMatrix();
